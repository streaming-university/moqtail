...
export namespace AnnounceErrorCode {
  export function tryFrom(v: bigint): AnnounceErrorCode {
    switch (v) {
      case 0x0n:
      ...
      default:
        throw new InvalidEnumValue('AnnounceErrorCode.tryFrom', v)
    }
  }
}
...
export namespace SubscribeErrorCode {
  export function tryFrom(v: bigint): SubscribeErrorCode {
    switch (v) {
      case 0x0n:
      ...
      default:
        throw new InvalidEnumValue('SubscribeErrorCode.tryFrom', v)
    }
  }
}
...
export namespace FetchErrorCode {
  export function tryFrom(v: bigint): FetchErrorCode {
    switch (v) {
      case 0x0n:
      ...
      default:
        throw new InvalidEnumValue('FetchErrorCode.tryFrom', v)
    }
  }
}
...
export namespace SubscribeAnnouncesErrorCode {
  export function tryFrom(v: bigint): SubscribeAnnouncesErrorCode {
    switch (v) {
      case 0x0n:
      ...
      default:
        throw new InvalidEnumValue('SubscribeAnnouncesErrorCode.tryFrom', v)
    }
  }
}
...
export namespace SubscribeDoneStatusCode {
  export function tryFrom(v: bigint): SubscribeDoneStatusCode {
    switch (v) {
      case 0x0n:
      ...
      default:
        throw new InvalidEnumValue('SubscribeDoneStatusCode.tryFrom', v)
    }
  }
}
